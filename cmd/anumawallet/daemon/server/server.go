...
import (
	...
	"github.com/AnumaNetwork/anumad-testnet/infrastructure/network/rpcclient"
	"github.com/AnumaNetwork/anumad-testnet/infrastructure/os/signal"
...
type server struct {
	pb.UnimplementedAnumawalletdServer
...
// Start starts the anumawalletd server
func Start(params *dagconfig.Params, listen, rpcServer string, keysFilePath string, profile string, timeout uint32) error {
	...
	pb.RegisterAnumawalletdServer(grpcServer, serverInstance)
