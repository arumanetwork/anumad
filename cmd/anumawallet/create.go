...
import (
	...
	"github.com/AnumaNetwork/anumad-testnet/cmd/anumawallet/libanumawallet/bip32"
...
func create(conf *createConfig) error {
	...
	fmt.Printf("Notice the above is neither a secret key to your wallet " +
		"(use \"anumawallet dump-unencrypted-data\" to see a secret seed phrase) " +
		"nor a wallet public address (use \"anumawallet new-address\" to create and see one)\n\n")
	...
	if len(signerExtendedPublicKeys) > 0 {
		cosignerIndex, err = libanumawallet.MinimumCosignerIndex(signerExtendedPublicKeys, extendedPublicKeys)
		if err != nil {
			return err
		}
	}
