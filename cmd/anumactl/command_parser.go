...
import (
	...
	"github.com/arumanetwork/anumad/infrastructure/network/netadapter/server/grpcserver/protowire"
	"github.com/pkg/errors"
)

func parseCommand(args []string, commandDescs []*commandDescription) (*protowire.AnumadMessage, error) {
	...
	return generateAnumadMessage(commandValue, commandDesc)
}
