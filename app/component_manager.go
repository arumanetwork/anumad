...
import (
	...
	"github.com/arumanetwork/anumad/app/rpc"
	"github.com/arumanetwork/anumad/domain"
	"github.com/arumanetwork/anumad/domain/consensus"
	"github.com/arumanetwork/anumad/domain/utxoindex"
	"github.com/arumanetwork/anumad/infrastructure/config"
	infrastructuredatabase "github.com/arumanetwork/anumad/infrastructure/db/database"
	...
	"github.com/arumanetwork/anumad/infrastructure/network/netadapter/id"
	"github.com/arumanetwork/anumad/util/panics"
)

// ComponentManager is a wrapper for all the anumad services
...
// Start launches all the anumad services.
...
// Stop gracefully shuts down all the anumad services.
func (a *ComponentManager) Stop() {
	// Make sure this only happens once.
	if atomic.AddInt32(&a.shutdown, 1) != 1 {
		log.Infof("Anumad is already in the process of shutting down")
		return
	}

	log.Warnf("Anumad shutting down")
