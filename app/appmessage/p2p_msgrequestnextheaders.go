...
// MsgRequestNextHeaders implements the Message interface and represents a anuma
...
// NewMsgRequestNextHeaders returns a new anuma RequestNextHeaders message that conforms to the
// Message interface.
