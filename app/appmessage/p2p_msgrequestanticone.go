...
// MsgRequestAnticone implements the Message interface and represents a anuma
...
// NewMsgRequestAnticone returns a new anuma RequestPastDiff message that conforms to the
