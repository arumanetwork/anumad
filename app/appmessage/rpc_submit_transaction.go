...
// RPCTransaction is a anumad transaction representation meant to be
// used over RPC
...
// RPCTransactionInput is a anumad transaction input representation
...
// RPCScriptPublicKey is a anumad ScriptPublicKey representation
type RPCScriptPublicKey struct {
	Version uint16
	Script  string
}

// RPCTransactionOutput is a anumad transaction output representation
// meant to be used over RPC
...
// RPCOutpoint is a anumad outpoint representation meant to be used
// over RPC
...
// RPCUTXOEntry is a anumad utxo entry representation meant to be used
// over RPC
