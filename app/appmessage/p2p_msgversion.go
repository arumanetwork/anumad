...
var DefaultUserAgent = fmt.Sprintf("/anumad:%s/", version.Version())

// MsgVersion implements the Message interface and represents a anuma version
...
// NewMsgVersion returns a new anuma version message that conforms to the
