...
// MsgTransactionNotFound defines a anuma TransactionNotFound message which is sent in response to
...
// NewMsgTransactionNotFound returns a new anuma transactionsnotfound message that conforms to the
