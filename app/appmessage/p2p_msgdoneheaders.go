...
// MsgDoneHeaders implements the Message interface and represents a anuma
...
// NewMsgDoneHeaders returns a new anuma DoneIBDBlocks message that conforms to the
// Message interface.
