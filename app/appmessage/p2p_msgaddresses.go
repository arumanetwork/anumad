...
// anuma Addresses message (MsgAddresses).
const MaxAddressesPerMsg = 1000

// MsgAddresses implements the Message interface and represents a anuma
// Addresses message.
...
// NewMsgAddresses returns a new anuma Addresses message that conforms to the
