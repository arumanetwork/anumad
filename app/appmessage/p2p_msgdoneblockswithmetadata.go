...
// MsgDoneBlocksWithTrustedData implements the Message interface and represents a anuma
...
// NewMsgDoneBlocksWithTrustedData returns a new anuma DoneBlocksWithTrustedData message that conforms to the
// Message interface.
