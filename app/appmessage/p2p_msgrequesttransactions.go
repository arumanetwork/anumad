...
// MsgRequestTransactions implements the Message interface and represents a anuma
...
// NewMsgRequestTransactions returns a new anuma RequestTransactions message that conforms to
