...
// MsgRequestAddresses implements the Message interface and represents a anuma
...
// NewMsgRequestAddresses returns a new anuma RequestAddresses message that conforms to the
