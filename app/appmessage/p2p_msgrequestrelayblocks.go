...
// MsgRequestRelayBlocks implements the Message interface and represents a anuma
...
// NewMsgRequestRelayBlocks returns a new anuma RequestRelayBlocks message that conforms to
