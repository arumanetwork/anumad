...
// installService attempts to install the anumad service. Typically this should
...
// removeService attempts to uninstall the anumad service. Typically this should
...
// startService attempts to Start the anumad service.
