...
type GetBlockTemplateRequestMessage struct {
	...
	// Which anuma address should the coinbase block reward transaction pay into
...
type GetBlockTemplateResponseMessage struct {
	...
	// Whether anumad thinks that it's synced.
	// Callers are discouraged (but not forbidden) from solving blocks when anumad is not synced.
	// That is because when anumad isn't in sync with the rest of the network there's a high
...
type GetConnectedPeerInfoMessage struct {
	...
	// Whether this anumad initiated the connection
	...
	// The timestamp of when this peer connected to this anumad
