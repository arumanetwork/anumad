...
func (x *AnumadMessage_Version) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "AnumadMessage_Version is nil")
	}
...
func (x *VersionMessage) toAppMessage() (appmessage.Message, error) {
	...
	//  Full anuma nodes set SubnetworkId==nil
	if err != nil && !errors.Is(err, errorNil) {
		return nil, err
	}
...
func (x *AnumadMessage_Version) fromAppMessage(msgVersion *appmessage.MsgVersion) error {
