...
func (x *AnumadMessage_Block) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "AnumadMessage_Block is nil")
	}
	return x.Block.toAppMessage()
}

func (x *AnumadMessage_Block) fromAppMessage(msgBlock *appmessage.MsgBlock) error {
