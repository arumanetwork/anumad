...
type P2P_MessageStreamClient interface {
	Send(*AnumadMessage) error
	Recv() (*AnumadMessage, error)
	grpc.ClientStream
}
...
func (x *p2PMessageStreamClient) Send(m *AnumadMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *p2PMessageStreamClient) Recv() (*AnumadMessage, error) {
	m := new(AnumadMessage)
...
func (x *p2PMessageStreamServer) Send(m *AnumadMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *p2PMessageStreamServer) Recv() (*AnumadMessage, error) {
	m := new(AnumadMessage)
...
func (x *rPCMessageStreamClient) Send(m *AnumadMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *rPCMessageStreamClient) Recv() (*AnumadMessage, error) {
	m := new(AnumadMessage)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *rPCMessageStreamServer) Send(m *AnumadMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *rPCMessageStreamServer) Recv() (*AnumadMessage, error) {
	m := new(AnumadMessage)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
