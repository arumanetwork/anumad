...
func (x *AnumadMessage_Transaction) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "AnumadMessage_Transaction is nil")
	}
	return x.Transaction.toAppMessage()
}

func (x *AnumadMessage_Transaction) fromAppMessage(msgTx *appmessage.MsgTx) error {
