...
func (x *AnumadMessage_Addresses) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "AnumadMessage_Addresses is nil")
	}
...
func (x *AnumadMessage_Addresses) fromAppMessage(msgAddresses *appmessage.MsgAddresses) error {
