...
import (
	...
	"github.com/arumanetwork/anumad/domain/consensus/utils/pow"
...
const miningAddress = "anumadev:qrcqat6l9zcjsu7swnaztqzrv0s7hu04skpaezxk43y4etj8ncwfkuhy0zmax"
...
func runDAATest(t *testing.T, testName string, runDuration time.Duration,
	...
	tearDownAnumad := common.RunAnumadForTesting(t, "anumad-daa-test", rpcAddress)
	defer tearDownAnumad()
